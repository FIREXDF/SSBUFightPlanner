...
const electronAPI = {
    ...
    onDownloadStatus: (callback) => ipcRenderer.on('download-status', (_, status) => callback(status)),
...
const generalAPI = {
    ...
    modOperations: {
        ...
        renameModFile: (modPath, oldPath, newPath) => ipcRenderer.invoke('rename-mod-file', { modPath, oldPath, newPath }),
