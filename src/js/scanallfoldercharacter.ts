export class CharacterScanner {
    ...
    async scanMods(force = false) {
        ...
        try {
            ...
            for (const mod of mods) {
                ...
                try {
                    scannedCount++;
                    const progress = document.getElementById("scan-progress") as HTMLSpanElement | undefined;
                    ...
                    if (fighterFolders.length > 0) {
                        ...
                        for (const character of characters) {
                            ...
                            try {
                                const {currentSlots} = await CharacterScanner.scanForSlots(
                                    characterPath
                                );
    ...
    renderList() {
        ...
        const existingInput = container.querySelector("#characterSearchInput") as HTMLInputElement | undefined;
    ...
    `;
        ...
        const searchInput = container.querySelector("#characterSearchInput") as HTMLInputElement | undefined;
    ...
    addEventListeners(container) {
        ...
        container.querySelectorAll(".clickable-image").forEach((img) => {
            img.addEventListener("click", (e) => {
                ...
                const modalImg = document.getElementById("characterImageLarge") as HTMLImageElement;
