...
export class ChangeSlots {
    ...
    static async changeSlots(modPath, slotChanges, finalSlots: Array<string>, pathData: PathData, fighterName, slotCustomNames, defaultCustomNames) {
        const changedPaths = [];
     ...
     */
    static async updateShareToVanilla(modPath, fighterName, finalSlots: Array<string>) {
        try {
            ...
            config["share-to-vanilla"] = ChangeSlots.orderObject(config["share-to-vanilla"], keyOrder);
     ...
     */
    static async updateNewDirInfos(modPath, fighterName, slotChanges: Array<string>) {
        try {
            ...
            const vanillaTemplates = [
                ...
                ...(fighterName === 'kirby' ? [] : ["fighter/{fighter}/kirbycopy/{slot}"]),
     ...
     */
    static async updateNewDirFiles(modPath, fighterName, slotChanges: Array<string>) {
        try {
            ...
            for (const [, newSlot] of Object.entries(slotChanges)) {
                ...
                for (const f of vanillaFiles) {
                    ...
                    // kirbycopy
                    if (
                        (f.startsWith(`fighter/kirby/model/copy_${fighterName}_cap/`) || f.startsWith(`fighter/kirby/model/copy_${fighterName}_sword/`)) &&
                        f.includes(`/c00/`)
                    ) {
     ...
     */
    static async updateNewDirInfosBase(modPath, fighterName, slotChanges: Array<string>) {
        try {
     ...
     * @param {Object} slotChanges - ex: { c00: c08 }
     */
    static async updateShareToAdded(modPath, fighterName, slotChanges: Array<string>) {
        try {
