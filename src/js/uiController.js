    ...
    try {
        ...
        document.querySelectorAll('.target-slot').forEach(select => {
            select.addEventListener('change', function () {
                const customInput = this.parentElement.querySelector('.custom-slot-input');
            ...
            try {
                ...
                document.querySelectorAll('.target-slot').forEach(select => {
                    ...
                    if (targetSlot === 'custom') {
                        const customInput = select.parentElement.querySelector('.custom-slot-input');
...
async handleChangeSlots(modPath, slotChanges, slotsToRemove, files) {
    try {
        ...
        await ChangeSlots.ensureMaxSlots(modPath);
